...
////
    ...
    public static Fragment fr = null;

    ArrayList<Student> all ;
////

    public MyRVAdapter(Fragment fragment) {
    try {
    ...
    public void onBindViewHolder(@NonNull MyViewHolper myViewHolper, int i) {
      ...
      ////
        ...
        // not complete
        myViewHolper.IBEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               ...
               //     mAdapterCallback.onMethodCallback();
                    ...
                    // do something
                    Log.d("ADAPTER Kero1",exception.toString());
                }
            }
        });
    }
    ...
    public static class MyViewHolper extends RecyclerView.ViewHolder{
        ...
        TextView tvrow;
        TextView tvcall;
        ImageButton IBVAShare,IBVACall, IBEdit;
